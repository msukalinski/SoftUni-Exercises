...
export class SUV extends BaseVehicle {
    ...
    constructor(id: number, model: string, engineCC: number, fourWheelDrive: boolean, basePrice: number) {
        super(id, model, engineCC, VehicleCategory.SUV);
        this.fourWheelDrive = fourWheelDrive;
        this._baseRentalPrice = basePrice;
    }
...
export class Truck extends BaseVehicle {
    ...
    constructor(id: number, model: string, engineCC: number, payloadTons: number, basePrice: number) {
